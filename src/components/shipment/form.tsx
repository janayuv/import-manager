      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-4xl">
        ...
        <div className="grid gap-6 py-4">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              <Label>BL/AWB #</Label>
              <Input id="blAwbNumber" value={formData.blAwbNumber || ''} onChange={handleChange} />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="vesselName" value={formData.vesselName || ''} onChange={handleChange} />
            </div>
            <div className="space-y-2">
          ...
          <div className="grid grid-cols-4 items-end gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input value={calculateTransitDays()} readOnly className="bg-muted" />
            </div>
            <div className="space-y-2">
              <Label>Status</Label>
              <CreatableCombobox
        ...
        <DialogFooter>
          <Button onClick={handleSubmit} style={{ backgroundColor: '#8aff80' }}>
            Save Shipment
          </Button>
        </DialogFooter>
      </DialogContent>
