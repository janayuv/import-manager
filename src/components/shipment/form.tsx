    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Fill in all the details for the shipment. Fields marked with * are
            required.
          </DialogDescription>
        </DialogHeader>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="space-y-2">
                  ...
                  <CreatableCombobox
                    ...
                    onOptionCreate={newOption =>
                      onOptionCreate('category', newOption)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <CreatableCombobox
                    ...
                    onOptionCreate={newOption =>
                      onOptionCreate('currency', newOption)
                    }
                    placeholder="e.g., USD"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <CreatableCombobox
                    ...
                    onOptionCreate={newOption =>
                      onOptionCreate('incoterm', newOption)
                    }
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="space-y-2">
                  ...
                  <CreatableCombobox
                    ...
                    onOptionCreate={newOption =>
                      onOptionCreate('status', newOption)
                    }
