        ...
        <ResponsiveTable>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <span className="bg-success/10 text-success rounded px-2 py-1 text-fluid-xs">
                  Active
                </span>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <span className="bg-warning/10 text-warning rounded px-2 py-1 text-fluid-xs">
                  Pending
                </span>
              </td>
              <td>
...
export const ResponsiveClassesExample: React.FC = () => {
  return (
    <div className="p-fluid">
      <h1 className="mb-4 text-fluid-2xl font-bold">
...
export const ResponsiveConditionalExample: React.FC = () => {
  ...
  return (
    <div className="p-fluid">
      <h2 className="mb-4 text-fluid-xl font-bold">
