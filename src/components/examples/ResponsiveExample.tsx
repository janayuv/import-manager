...
export const ResponsiveExample: React.FC = () => {
  ...
  return (
    <ResponsiveContainer>
      ...
      <div className="mb-6">
        <ResponsiveText size="3xl" className="mb-2 font-bold">
      ...
      <ResponsiveGrid variant="lg" className="mb-6">
        {/* KPI Cards */}
        <ResponsiveCard>
          <ResponsiveSpacing>
            ...
            <div>
              ...
              <ResponsiveText size="2xl" className="font-bold">
                1,234
              </ResponsiveText>
            </div>
          </ResponsiveSpacing>
      ...
      <ResponsiveCard className="mb-6">
        <ResponsiveText size="xl" className="mb-4 font-semibold">
          Responsive Form
        </ResponsiveText>
        <ResponsiveSpacing variant="lg">
          <div>
            <ResponsiveText size="sm" className="mb-2 block">
              Name
            </ResponsiveText>
          ...
          <div>
            ...
            <ResponsiveInput type="email" placeholder="Enter your email" />
          </div>
          <div>
            <ResponsiveText size="sm" className="mb-2 block">
              Message
          ...
          <ResponsiveButton onClick={() => alert('Form submitted!')}>
            Submit Form
          </ResponsiveButton>
        </ResponsiveSpacing>
      </ResponsiveCard>
      ...
      <ResponsiveCard>
        ...
        <ResponsiveTable>
          <thead>
            <tr>
              <th>
                <ResponsiveText size="sm" className="font-semibold">
                  Supplier Name
                </ResponsiveText>
              </th>
              <th>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <span className="text-fluid-xs bg-success/10 text-success rounded px-2 py-1">
                  Active
                </span>
              </td>
              <td>
                <ResponsiveSpacing variant="sm">
                  <ResponsiveButton variant="sm" size="sm">
                    Edit
                  </ResponsiveButton>
                  <ResponsiveButton variant="sm" size="sm">
                    View
            ...
            <tr>
              ...
              <td>
                <span className="text-fluid-xs bg-warning/10 text-warning rounded px-2 py-1">
                  Pending
                </span>
              </td>
              <td>
      ...
      <ResponsiveCard className="mt-6">
        <ResponsiveText size="lg" className="mb-4 font-semibold">
          Debug Information
        </ResponsiveText>
        <ResponsiveSpacing variant="sm">
          <div>
...
export const ResponsiveClassesExample: React.FC = () => {
  return (
    <div className="p-fluid">
      <h1 className="text-fluid-2xl mb-4 font-bold">
        Direct CSS Classes Example
      </h1>

      <div className="space-fluid">
        <button className="btn-fluid bg-primary text-primary-foreground">
          Default Button
        </button>
        <button className="btn-fluid-sm bg-success text-success-foreground">
          Small Button
        </button>
        <button className="btn-fluid-lg bg-destructive text-destructive-foreground">
          Large Button
        </button>
      </div>
      ...
      <div className="card-fluid mt-6">
        <h3 className="text-fluid-lg font-semibold">
          Card with Direct Classes
        </h3>
        <p className="text-fluid-base">
          This card uses direct CSS classes for responsive scaling.
        </p>
      </div>
    </div>
  );
...
export const ResponsiveConditionalExample: React.FC = () => {
  ...
  return (
    <div className="p-fluid">
      <h2 className="text-fluid-xl mb-4 font-bold">
      ...
      {isSmallScreen && (
        <div className="card-fluid-sm bg-warning/10">
          <p className="text-fluid-sm">
            This content only shows on small screens (≤1366px)
          </p>
        </div>
      )}
      ...
      {isLargeScreen && (
        <div className="card-fluid-lg bg-success/10">
          <p className="text-fluid-lg">
            This content only shows on large screens (&gt;1920px)
          </p>
        </div>
      )}
