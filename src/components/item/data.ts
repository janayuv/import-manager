...
export const initialBcdRates: Option[] = [ { value: '0', label: '0.0%' }, { value: '7.5', label: '7.5%' }, { value: '10', label: '10.0%' }, { value: '15', label: '15.0%' } ];
export const initialSwsRates: Option[] = [ { value: '10', label: '10.0%' } ];
export const initialIgstRates: Option[] = [ { value: '12', label: '12.0%' }, { value: '18', label: '18.0%' }, { value: '28', label: '28.0%' } ];
