...
export function CreatableCombobox({
  options, value, onChange, onOptionCreate,
  placeholder = "Select...", searchPlaceholder = "Search or create...",
  notFoundText = "Nothing found.", disabled = false
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-full p-0" style={{ width: 'var(--radix-popover-trigger-width)' }}>
        <Command shouldFilter={false}> {/* We handle filtering manually to show "Create..." */}
          <CommandInput
          ...
          <CommandList>
            <CommandEmpty>
              ...
              {!exactMatch && searchQuery ? (
                <CommandItem onSelect={handleCreate} className="flex items-center gap-2 cursor-pointer">
