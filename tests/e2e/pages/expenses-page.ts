...
export class ExpensesPage {
  ...
  async addExpense(expenseData: {
    ...
    if (expenseData.remarks) {
      await this.utils.fillField('[data-testid="remarks-input"]', expenseData.remarks)
    }
  ...
  async editExpense(
    ...
    if (newData.amount) {
      await this.utils.fillField('[data-testid="amount-input"]', newData.amount)
    }
    if (newData.remarks) {
      await this.utils.fillField('[data-testid="remarks-input"]', newData.remarks)
    }
